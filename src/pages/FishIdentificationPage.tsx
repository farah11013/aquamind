...
import { Upload, Camera, Loader2, CheckCircle, Fish, MapPin, AlertCircle } from 'lucide-react';
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    {result.species.distribution_range && (
                      <div>
                        <h4 className="font-semibold mb-2">Distribution Range</h4>
                        <p className="text-sm text-muted-foreground">
                          {result.species.distribution_range}
                        </p>
                      </div>
                    ...
                    {result.species.biological_characteristics && (
                      <div>
                        <h4 className="font-semibold mb-2">Biological Characteristics</h4>
                        <p className="text-sm text-muted-foreground">
                          {result.species.biological_characteristics}
                        </p>
                      </div>
